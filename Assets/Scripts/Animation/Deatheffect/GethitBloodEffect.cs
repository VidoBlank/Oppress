...
public class GethitBloodEffect : StateMachineBehaviour
{
    public string effectName = "Blood_Gethit"; // 子物体的名称
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            particleSystem.Stop(); // 停止播放粒子效果
        }

        if (effectObject != null)
        {
            effectObject.SetActive(false); // 关闭特效
        }
